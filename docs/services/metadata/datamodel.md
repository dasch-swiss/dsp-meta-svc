...
| abstracts           | abstracts describing the dataset                                        | 1-n         | `abstractTexts` and `abstractURLs` | MultiLanguageText[] and URL[] | `abstract`           | array of object (multi-language text or URL) | `:hasAbstract`                                                  | xsd:string          | 1-n             | ?                              |
...
| alternative titles  | alternative titles of the dataset                                       | 0-n         | `alternativeTitles`                | MultiLanguageText[]           |                      |                                              |                                                                 |                     |                 |                                |
| URLs                |                                                                         |             |                                    |                               |                      |                                              |                                                                 |                     |                 |                                |
| additional          |                                                                         |             |                                    |                               |                      |                                              |                                                                 |                     |                 |                                |
